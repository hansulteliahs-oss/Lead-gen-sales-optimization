...
- [ ] **AUTH-01**: Operator can log in with email and password and access all LCC accounts
- [ ] **AUTH-02**: LCC can log in with email and password and see only their own pipeline data
...
- [ ] **AUTH-06**: Operator account bypasses RLS to access all tenant data
...
| LEAD-01–06 | Phase 2 | Pending |
| PIPE-01–05 | Phase 2 | Pending |
| AUTO-01–06 | Phase 2 | Pending |
| AI-01–03 | Phase 3 | Pending |
| DASH-01–05 | Phase 3 | Pending |
| OPS-01–05 | Phase 4 | Pending |
| BILL-01–04 | Phase 4 | Pending |
